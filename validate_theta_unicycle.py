...
if __name__ == "__main__":
    ...
    # ---------------- Figure (single panel) ----------------
    # Only the illustrative-trajectory panel is plotted; the Ferro-Segers
    # data-driven cross-check above is still computed and printed to the
    # console as the quantitative validation, it's just not rendered as a
    # separate subplot.
